...
CREATE TABLE `user_library` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `user_library_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `user_library_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`)
...
INSERT INTO `user_library` VALUES (7,2,4);
